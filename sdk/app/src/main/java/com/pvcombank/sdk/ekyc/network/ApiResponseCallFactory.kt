...
class ApiResponseCallFactory: CallAdapter.Factory() {
	override fun get(
		returnType: Type,
		...
		val errorBodyConverter = retrofit.nextResponseBodyConverter<ResponseData<Any>>(null, errorBodyType, annotations)
